...
public class PseudoCompressedStringComparison {
    public static void main(String[] args) {
        ...
        System.out.println("ad " + "ad0000 " + kurbanVersion("ad", "ad0000"));
        System.out.println("ad " + "ad0000 " + gregVersion("ad", "ad0000"));
    }
    ...
    private static boolean gregVersion(String literal, String compressed) {
        ...
        if (compressed.endsWith("0")) {
            return compressed.substring(0, compressed.indexOf("0")).equals(literal);
        }
        ...
        while (litPointer < literalLength && compPointer < compressedLength) {
            ...
            } else if (compressed.charAt(compPointer) == literal.charAt(litPointer)) {
                litPointer++;
            } else {
                return false;
            }
